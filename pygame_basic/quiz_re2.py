...
#배경이미지 불러오기
backgruound = pygame.image.load("C:/Users/김대기/Desktop/python git/practice/pygame_basic/background.png")
...
#적 캐릭터
enemy = pygame.image.load("C:/Users/김대기/Desktop/python git/practice/pygame_basic/enemy.png")
...
#시간 계산
strart_ticks = pygame.time.get_ticks() # 시작 tick을 받아옴
...
#충돌 처리를 위한 rect 정보 업데이트
    ...
    enemy_rect.top = enemyr_y_pos
    
    # 충돌체크
    if character_rect.colliderect(enemy_rect) :
        print("충돌했어요")
        running = False
    screen.blit(backgruound, (0, 0)) # 배경 그리기
    screen.blit(character, (character_x_pos, character_y_pos)) # 캐릭터 그리기
    screen.blit(enemy, (enemy_x_pos, enemyr_y_pos))

    #타이머 집어 넣기
    #경과 시간 계산
    elapsed_time = (pygame.time.get_ticks() - strart_ticks) / 1000 #경과 시간(ms)을 1000으로 나누어 초 단위 로 표시
